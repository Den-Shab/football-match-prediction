...
Важно отметить тот факт, что модель могла быть обучена только на тех показателях, которые могут быть теоретически известны на момент начала матча (например, нельзя использовать наличие красных карточек, так как для предсказания будущего матча невозможно определить, будет получена красная карточка или нет). Именно поэтому достаточно большую роль играет feature_engineering, в ходе которого были получены некоторые важные статистические показатели 
Именно поэтому угадывать результаты в почти двух из трех случаев - достаточно качественный показатель, если учитывать то количество факторов, в действительности влияющее на результат и не поддающееся замерам
...
Это демонстрирует и практическую значимость модели, и метод, как данный инструмент может приносить прибыль (помимо этого, прогнозы можно продавать и также получать прибыль
